  ...
  return (
    <section className="grid gap-4" aria-labelledby="featured-resources-title">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 id="featured-resources-title" className="text-2xl font-semibold">
            {heading}
          </h2>
        ...
        <Link
          href="/resources"
          className="inline-flex min-h-12 items-center rounded-md px-3 text-sm font-semibold text-[var(--color-action-primary)] hover:bg-[var(--color-action-muted)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-action-primary)]"
        >
          전체 자료 보기
        </Link>
      </div>
